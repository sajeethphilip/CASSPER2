...
def PredictMRC(image=None,Model='default',model_path='models/',model_name='BestFr_InceptionV4_model_FRRN-B.ckpt',crop_height=512,crop_width=512,model="FRRN-B",dataset="./png/",mrcsrc="./mrc/",Savestar=True,CrossMatch=False,Box=True):
    ...
    print("------------------------------------------------------------------------------------------------------")
    print("Command is PredictMRC(image=None,model='default',model_path='/models/',model_name='BestFr_InceptionV4_model_FRRN-B.ckpt',crop_height=512,crop_width=512,model='FRRN-B',dataset='./png/',mrcsrc='./mrc/',Savestar=True,CrossMatch=False,Box=True)")
    print("------------------------------------------------------------------------------------------------------")
    print("")
